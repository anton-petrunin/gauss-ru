...
\]
Векторы $\tan(s)$, $\norm(s)$ и $\bi(s)$ называются \index{касательный вектор}\emph{касательным}, \index{нормальный вектор}\emph{нормальным} и \index{бинормальный вектор}\emph{бинормальным} базиса Френе, соответственно.
...
Более того, $\gamma$ однозначно определена с точностью до изометрии пространства, сохраняющей ориентацию.
\end{thm}
...
Применив изометрию пространства, можно считать, что $\gamma_1(s_0)=\gamma_2(s_0)$ и базисы Френе кривых совпадают при $s_0$.
