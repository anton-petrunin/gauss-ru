...
КРИВЫЕ И ПОВЕРХНОСТИ\qquad Петрунин и Замора Баррера}}
...
Учебник рассчитан на тех, кто решил заниматься дифференциальной геометрией или же хочет иметь вескую причину этого не делать.}
\end{flushleft}
\vfill
\begin{flushleft}
{}
