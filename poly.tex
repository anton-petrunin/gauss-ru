...
она поможет обзавестись правильной геометрической интуицией кривизны.
...
То же определение можно применить если $\alpha$ и/или $\beta$ определены на полуоткрытых интервалах
$(a,b]$ и/или $[b,c)$.
...
Пространственная кривая $\gamma$ называется \index{кусочно-гладкая кривая}\emph{кусочно-гладкой}, если её можно представить как произведение конечного числа гладких кривых; если $\gamma$ замкнута, то предполагается, что произведение циклическое.

Если $\gamma$ --- произведение гладких дуг $\gamma_1,\dots,\gamma_n$, то полная кривизна $\gamma$ определяется как сумма полных кривизн $\gamma_i$ и внешних углов;
то есть 
...
каждая дуга в их произведении является отрезком прямой.
...
Пусть ломаная $p_1\dots p_n$ вписана в гладкую кривую~$\gamma$.
Тогда 
\[\tc\gamma\ge \tc{p_1\dots p_n}.\]
Более того, если $\gamma$ замкнута, то можно считать, что ломаная $p_1\dots p_n$ также замкнута.
...
полная кривизна ломаной $p_1\dots p_n$ равна сумме внешних углов $\theta_i$.

По неравенству треугольника для углов \ref{thm:spherical-triangle-inq}, 
\[\theta_i\le \alpha_i+\beta_i.\]
По лемме о хорде (\ref{lem:chord}), полная кривизна дуги $\gamma$ от $p_i$ до $p_{i+1}$ не меньше $\alpha_i+\beta_{i+1}$.
Таким образом, 
\begin{align*}
...
Достаточность следует из \ref{cor:fenchel=convex};
...
Значит из вышесказанного получаем
\begin{align*}
\tc{abcd}\ge 4\cdot \pi 
...
То есть, любой четырёхугольник, вписанный в $\gamma$, плоский и выпуклый.
...
Равенство в упражнении используется в определении полной кривизны произвольной кривой~$\gamma$ --- её определяют как \textit{точную верхнюю грань полной кривизны невырожденных ломаных, вписанных в~$\gamma$.}
...
Постройте пример, показывающий, что обратное неверно.
\end{thm}
